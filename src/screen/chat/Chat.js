                        ...
                        <View style={{ flexDirection: 'column', justifyContent: 'space-between', flex: 1 }}>
                            {
                                ...
                                chatMesg.map((i, index) => {
                                    ...
                                    if (i.senderUid === currentUser.UID) {
                                        return (
                                            <View key={index} style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'flex-end', right: 0 }}>
                                                <View style={{ flex: 1, backgroundColor: '#37e879', width: 250, borderRadius: 12, justifyContent: 'flex-end', alignItems: 'flex-end', borderWidth: 2, overflow: 'hidden', borderColor: '#ffffff' }}>
                                        ...
                                        return (
                                            <View key={index} style={{ flex: 1, alignItems: 'flex-start', justifyContent: 'flex-start', left: 0 }}>
                                                <View style={{ flex: 1, backgroundColor: '#cdddf7', width: 250, borderRadius: 12, justifyContent: 'flex-start', alignItems: 'flex-start', borderWidth: 2, overflow: 'hidden', borderColor: '#ffffff' }}>
                                                    <Text style={{ fontSize: 18, padding: 1, fontWeight: '500', marginTop: 5, marginLeft: 6, marginRight: 6 }}>{i.message}</Text>
                                                    <Text style={{ fontSize: 12, margin: 5, color: 'gray' }}>
                                                        {moment((i.date)).format(" h:mm: A")}
                                                    </Text>
